...
import { ToolType, ToolStatus, ToolService } from '@/types';
...
type AddToolFormValues = z.infer<typeof addToolSchema>;
...
export function AddToolDialog({ open, onOpenChange }: AddToolDialogProps) {
  ...
  const onSubmit = (data: AddToolFormValues) => {
    createMutation.mutate({
      ...
      estimateTime: data.estimateTime || undefined,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Add a new automation tool to the system.
          </DialogDescription>
        </DialogHeader>
